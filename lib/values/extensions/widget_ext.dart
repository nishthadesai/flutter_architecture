...
extension WidgetX on Widget {
  ...
  Widget wrapPaddingOnly(
    ...
    return Padding(
      padding:
          EdgeInsets.only(left: left, right: right, top: top, bottom: bottom).r,
      child: this,
    );
  }
  ...
  Widget wrapPaddingSymmetric(
    ...
    return Padding(
      padding:
          EdgeInsets.symmetric(vertical: vertical, horizontal: horizontal).r,
      child: this,
    );
  }
  ...
  Widget wrapPaddingTop(double top) {
    return Padding(
      padding: EdgeInsets.only(top: top).r,
      child: this,
    );
  }
  ...
  Widget wrapPaddingBottom(double bottom) {
    return Padding(
      padding: EdgeInsets.only(bottom: bottom).r,
      child: this,
    );
  }
  ...
  Widget wrapPaddingLeft(double left) {
    return Padding(
      padding: EdgeInsets.only(left: left).r,
      child: this,
    );
  }
  ...
  Widget wrapPaddingRight(double right) {
    return Padding(
      padding: EdgeInsets.only(right: right).r,
      child: this,
    );
  }
